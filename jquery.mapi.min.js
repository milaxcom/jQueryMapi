/* jQueryMapi v1.1.1 */
var mapi=function(a){if("string"==typeof a)return mapi.findInit(a),a;mapi.storage=[];(a=$("meta[name='mapi:storage-url']").attr("content"))&&$.ajax({data:{request:"*"},url:a,dataType:"JSON",success:function(a){mapi.storage=a;mapi.autoInit()}})};
mapi.ready=function(a){var b={yandex:"undefined"==typeof ymaps||"undefined"==typeof ymaps.Map?!1:!0,google:"undefined"==typeof google||"undefined"==typeof google.maps||"undefined"==typeof google.maps.Map?!1:!0,dblgis:"undefined"==typeof DG||"undefined"==typeof DG.map?!1:!0};return"undefined"!=typeof a?b[a]:b};
